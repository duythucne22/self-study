...
// Transfer performs a money transfer one account to other
// It create a transfer record, add new account entry, and update accounts' balance within a single database transaction
